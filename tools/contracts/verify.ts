import { getProfileEntryForBuiltIndex } from '../../src/domain/experience/videoStack'
import { IMPLEMENTED_VIDEO_NODES } from '../../src/runtime/capabilities'
import { resolveAnalyserTarget } from '../../src/runtime/coupling'
import { buildAudioNodeLookup, getAudioRegistrySummaries } from './probes/audioNodeRegistry'
import { buildVideoNodeLookup, getVideoRegistrySummaries } from './probes/videoNodeRegistry'
import type {
  ContractIssue,
...
import { evaluatePolicyChecks } from './checks/policy'
import { loadContractJsonReferences } from './jsonReferences'
...
function verifyReactiveVideo({
  ...
  const entry = getProfileEntryForBuiltIndex(
    ...
    { reducedMotion: false, supportedNodeIds: IMPLEMENTED_VIDEO_NODES },
  )
