 ...
 * Audio Graph Builder
 *
 * This module parses an experience profile's `audio_stack.chain`
...
import type { AudioNodeId } from '../capabilities'
import {
  createLowpass,
  createHighpass,
  createTremolo,
...
export const FX_FACTORY: Record<string, NodeFactory> = {
...
} satisfies Record<AudioNodeId, NodeFactory>
