 ...
 * stored under `src/content/experience/profiles/`, as well as the main `catalog.json`.
 *
...
// ---------------------------------------------------------------------------
// Experience Dimensions file (src/content/experience/experience-dimensions.json)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Dimension-to-Signal Mapping file (src/content/experience/dimension-to-signal-mapping.json)
// ---------------------------------------------------------------------------
