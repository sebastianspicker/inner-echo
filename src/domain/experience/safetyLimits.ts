/**
 * Global Experience Safety Limits
 *
 ...
 *
 * These global limits are baked into the application and act as a hard ceiling.
 * Individual experience profiles can request lower limits (via `safety.safe_mode_clamps`),
