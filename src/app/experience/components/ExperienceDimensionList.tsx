...
import { strengthBadge, EvidenceButton, upsertDimension } from '../session/composerUtils'
...
interface ExperienceDimensionRowsProps {
...
function ExperienceDimensionRows({
  dims,
  dimIds,
  dimensions,
  onDimensionsChange,
  onOpenEvidence,
}: ExperienceDimensionRowsProps) {
  return dims.map((dim) => {
...
export interface ExperienceDimensionListProps {
  dims: ExperienceDimensionDef[]
...
export function ExperienceDimensionList({
  dims,
  dimById,
  dimIds,
  dimensions,
