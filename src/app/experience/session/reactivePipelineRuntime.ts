...
export interface ReactiveOverlayModules {
  graphBuilder: Pick<typeof import('../../../runtime/visual/graph'), 'buildVideoNodes'>
  reactiveRuntime: ReactiveRuntime
  canvasRuntime: Pick<typeof import('../../../runtime/visual/overlay'), 'startOverlayLoop'>
}
...
export async function loadReactiveOverlayModules(): Promise<ReactiveOverlayModules> {
  const [graphBuilder, reactiveRuntime, canvasRuntime] = await Promise.all([
    import('../../../runtime/visual/graph'),
    import('../../../runtime/coupling'),
    import('../../../runtime/visual/overlay'),
  ])
