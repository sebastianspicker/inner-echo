...
| **Derealization** (`derealization`) | medium | `docs/references/dimensions/derealization.md` | `haze, chromatic_aberration, temporal_smear, color_grade` | `flutter, lowpass, reverb, compressor_limiter` |
| **Depersonalization** (`depersonalization`) | medium | `docs/references/dimensions/depersonalization.md` | `vignette, soft_blur, chromatic_aberration, color_grade` | `reverb, lowpass, flutter, compressor_limiter` |
