...
- Compulsive Loop (`compulsive_loop`): Evidence (dimension): High: Claim: Artistic: `docs/references/dimensions/compulsive_loop.md`: corpus: `docs/references/research/remaining-dimensions.md`: claim sources: `docs/references/CONTRIBUTIONS_AND_LIMITS.md`
