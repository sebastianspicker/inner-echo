...
- **Video nodes**: `vignette`, `soft_blur`, `chromatic_aberration`, `color_grade`
...
| `chromatic_aberration` | Minor RGB channel offset near edges (very low). | **Artistic** | **Medium** | `docs/references/dimensions/depersonalization.md`, `docs/references/EVIDENCE_MATRIX.md`, `docs/references/motifs/chromatic_aberration.md`, `docs/references/CONTRIBUTIONS_AND_LIMITS.md` |
