...
| **derealization** | World feels distant/unreal/“behind glass”; reduced affective salience | haze, chromatic_aberration (very low), temporal_smear (very low), color_grade | flutter, lowpass, reverb (gentle), compressor_limiter | `docs/references/reports/deep-research-report-2.md` | **Medium** |
| **depersonalization** | Detachment from self/body; reduced agency; observer stance | vignette, soft_blur, chromatic_aberration (micro), color_grade | reverb, lowpass, flutter, compressor_limiter | `docs/references/reports/deep-research-report-2.md` | **Medium** |
