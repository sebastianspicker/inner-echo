...
Across dimensions, the strongest and most design-relevant empirical patterns are: (1) involuntary **intrusions** can be cue-triggered, vivid, and present-oriented (“nowness”), and can be modeled/altered in controlled paradigms and diary studies citeturn18view0turn27view0turn26search13; (2) **rumination / repetitive negative thinking** is characterized by repetitiveness, intrusiveness, and difficulty disengaging, and relates to symptom maintenance across disorders, with measurable cognitive/neural correlates citeturn31view0turn32view0turn52search3; (3) **emotional numbing / anhedonia** is complex and often selective (not “no feelings”), with growing reward-processing evidence but meaningful heterogeneity and counterevidence citeturn50view0turn49search18turn49search21. For dissociation-related dimensions (**derealization/depersonalization**), the most defensible mapping is “altered salience/affective coloring and distance” rather than dramatic distortions (to avoid sensationalism), consistent with systematic reviews and scale-based phenomenology citeturn44search2turn45view0turn44search8.
...
**Key verification note (applies to the above files):** Core peer-reviewed sources supporting the most constraint-heavy design inferences were retrieved and checked via publisher/PubMed pages for intrusion citeturn18view0turn26search13turn21search15turn30search0, rumination citeturn31view0turn32view0turn52search0turn52search3, emotional numbing citeturn50view0turn49search18turn49search21turn49search14, cognitive fog citeturn35search6turn38view0turn35search23turn35search21, time dilation citeturn40view0turn41view0turn7search6turn7search7, dissociation dimensions citeturn44search2turn45view0turn44search8turn43search4, sensory overload citeturn13view0turn46view0turn12search10, attention fragmentation citeturn47view0turn48view0turn14search12, and compulsive loop citeturn16search12turn51view0turn17search5turn17search1.
