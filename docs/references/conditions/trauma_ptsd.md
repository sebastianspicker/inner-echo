# Trauma / PTSD (Hyperarousal + Intrusion) — evidence summary
...
- **Hypervigilance** (`hypervigilance`, weight 60%) — Evidence: **Medium** — `docs/references/dimensions/hypervigilance.md`
