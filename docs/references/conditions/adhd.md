# ADHD (Attention Fragmentation / Overload): evidence summary
...
- Attention Fragmentation (`attention_fragmentation`, weight 85%): Evidence: Medium: `docs/references/dimensions/attention_fragmentation.md`
- Hyperarousal (`hyperarousal`, weight 35%): Evidence: High: `docs/references/dimensions/hyperarousal.md`
- Sensory Overload (`sensory_overload`, weight 55%): Evidence: Medium: `docs/references/dimensions/sensory_overload.md`
...
- `focus_jitter`: Small, smoothed focal instability (bounded).: `docs/references/motifs/focus_jitter.md`
...
- `tremolo`: Slow amplitude modulation (rate/depth clamped).: `docs/references/motifs/tremolo.md`
