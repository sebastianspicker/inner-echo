# OCD (Intrusion + Compulsive Loop): evidence summary
...
- Compulsive Loop (`compulsive_loop`, weight 60%): Evidence: High: `docs/references/dimensions/compulsive_loop.md`
- Intrusion (`intrusion`, weight 55%): Evidence: Medium: `docs/references/dimensions/intrusion.md`
- Rumination Loop (`rumination_loop`, weight 75%): Evidence: High: `docs/references/dimensions/rumination_loop.md`
...
- `grid_hint`: Subtle grid overlay hint (very low contrast).: `docs/references/motifs/grid_hint.md`
