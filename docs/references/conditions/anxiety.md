# Anxiety (Generalized / Social) — evidence summary
...
- **Hyperarousal** (`hyperarousal`, weight 80%) — Evidence: **High** — `docs/references/dimensions/hyperarousal.md`
- **Hypervigilance** (`hypervigilance`, weight 70%) — Evidence: **Medium** — `docs/references/dimensions/hypervigilance.md`
- **Rumination Loop** (`rumination_loop`, weight 30%) — Evidence: **High** — `docs/references/dimensions/rumination_loop.md`
