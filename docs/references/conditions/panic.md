...
- **Evidence summary (conservative)**: **High**
...
- **Hyperarousal** (`hyperarousal`, weight 70%) — Evidence: **High** — `docs/references/dimensions/hyperarousal.md`
- **Panic Peaks** (`panic_peaks`, weight 90%) — Evidence: **High** — `docs/references/dimensions/panic_peaks.md`
