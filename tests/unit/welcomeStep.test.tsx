...
describe('ui/WelcomeStep', () => {
  ...
  it('renders an in-flow welcome with accurate privacy and storage disclosure', () => {
    ...
    expect(screen.getByRole('heading', { name: /notice what shifts/i })).toBeInTheDocument()
    expect(screen.getByText(/not recorded or uploaded/i)).toBeInTheDocument()
